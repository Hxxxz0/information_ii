...
export const MenuBar: React.FC = () => {
  ...
  return (
    <div className="flex justify-between items-start pt-6 px-8 select-none z-10 relative">
      {/* Left: Time & Weather */}
      <div className="flex flex-col">
        <div className="flex items-center gap-4">
          <h1 className="text-6xl font-black text-slate-800 tracking-tight" style={{ fontFamily: 'system-ui' }}>
            {formatTime(time)}
          </h1>
      ...
      <div className="flex items-center gap-6 mt-2">
        {/* Coin Pill */}
        <div className="bg-yellow-100 border border-yellow-200 rounded-full px-4 py-2 flex items-center gap-2 shadow-sm">
        ...
        <div className="flex gap-4">
           <button className="flex items-center gap-2 glass-card px-4 py-2 rounded-xl text-slate-700 font-bold hover:bg-white hover:scale-105 transition-all">
